<div>
    ...
    <div class="intro-y col-span-12">
        ...
        <div class="intro-y box">
                                        ...
                                        <td class="text-center font-medium">{{ \Carbon\Carbon::parse($factura->fechaAutorizacion)->format('d-m-Y') }}</td>
                                         ...
                                         <td class="dark:border-dark-5 text-center">
                                            ...
                                            @if($factura->notasCredito->count() > 0)
                                                <button class="btn btn-secondary text-white border-0 ml-3"
                                                    disabled
                                                    title="Nota de Crédito ya emitida: {{ $factura->notasCredito->first()->secuencial }}">
            ...
            @include('livewire.listadofacturas.modalNC')
        </div>
        ...
        <script>
            ...
            window.addEventListener('open-modal-nc', event => {
                openModalNC();
            });
    ...
    <script>
        ...
        // Funciones para Modal NC
        function openModalNC() {
            var modal = document.getElementById("modalNC");
            console.log('Abriendo Modal NC');
            modal.classList.add("overflow-y-auto", "show");
            // Important: Force display block
            modal.style.cssText = "display: block; margin-top: 0px; margin-left: 0px; z-index: 1000;";
        }
        ...
        window.addEventListener('close-modal-nc', event => {
             closeModalNC();
        });
